...
try:
    ...
    QuantizedCacheConfig = StaticCache
...
try:
    ...
    def _prepare_attention_mask(*args, **kwargs):
        return kwargs.get("attention_mask")

    def _prepare_token_type_ids(*args, **kwargs):
        return kwargs.get("token_type_ids")
try:
    ...
    # Compatibility shims for newer transformers (names removed in 4.53+)
    from transformers.generation.configuration_utils import (
        GenerationConfig,
        GenerationMode,
    )
